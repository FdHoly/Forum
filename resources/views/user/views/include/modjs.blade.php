...
<!-- nice select JS -->
<script src=" {{ asset('user/assets/js/plugins/nice-select.min.js') }} "></script>
<!-- audio video player JS -->
<script src=" {{ asset('user/assets/js/plugins/plyr.min.js') }} "></script>
<!-- perfect scrollbar js -->
<script src=" {{ asset('user/assets/js/plugins/perfect-scrollbar.min.js') }} "></script>
<!-- light gallery js -->
<script src=" {{ asset('user/assets/js/plugins/lightgallery-all.min.js') }} "></script>
<!-- image loaded js -->
