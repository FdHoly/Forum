...
<title>:: BigBucket :: UI Elements</title>
...
<nav class="navbar custom-navbar navbar-expand-lg py-2">
    <div class="container-fluid px-0">
        <a class="navbar-brand" href="javascript:void(0);"><img src="../assets/images/brand/icon.svg" alt="BigBucket" /> <strong>Big</strong> Bucket</a>
        <div id="navbar_main">
    ...
    <div class="left_sidebar">
        <nav class="sidebar">
            ...
            <ul id="main-menu" class="metismenu">
                ...
                <li class="active"><a href="ui-elements.html"><i class="ti-vector"></i><span>UI Elements</span></a></li>
                ...
                <div class="col-lg-11">
                        ...
                        <div class="col-sm-4">
                            <a>
                                <div class="typeface-entry">
                                    ...
                                    <h3 class="heading display-3 font-weight-400 text-dark">Aa</h3>
                        ...
                        <div class="col-sm-4">
                            <a>
                                <div class="typeface-entry">
                                    ...
                                    <h3 class="heading display-3 font-weight-600 text-dark">Aa</h3>
                        ...
                        <div class="col-sm-4">
                            <a data-value="'Quicksand', sans-serif">
                                <div class="typeface-entry">
                                    ...
                                    <h3 class="heading display-3 font-weight-700 text-dark">Aa</h3>
                                    <p>A shining crescent far beneath the flying.</p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="row-wrapper">
                        ...
                        <div class="row color-palette cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-4">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Primary">
                            ...
                            <div class="col-4">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Secondary">
                                    <div class="color-entry bg-secondary">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#e8f2ff</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Tertiary">
                                    <div class="color-entry bg-tertiary">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#192b3f</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row color-palette cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Warning">
                                    <div class="color-entry bg-warning">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#ffab32</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Danger">
                                    <div class="color-entry bg-danger">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#f75554</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Success">
                                    <div class="color-entry bg-success">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#38bb56</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Info">
                                    <div class="color-entry bg-info">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#2bcbba</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="row color-palette cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Dark">
                                    <div class="color-entry bg-dark">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#343a40</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Light">
                                    <div class="color-entry bg-light">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#adb5bd</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Pink">
                                    <div class="color-entry bg-pink">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#f66d9b</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Purple">
                                    <div class="color-entry bg-purple">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#a55eea</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="row color-palette cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Azure">
                                    <div class="color-entry bg-azure">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#45aaf2</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Indigo">
                                    <div class="color-entry bg-indigo">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#6574cd</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Cyan">
                                    <div class="color-entry bg-cyan">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#17a2b8</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="javascript:void(0);" data-toggle="tooltip" title="Blush">
                                    <div class="color-entry bg-blush">
                                        <span class="color-code z-depth-2 font-weight-bold text-uppercase rounded">#de5d83</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <select class="selectpicker" title="Icons">
                                    <option data-icon="fa fa-bell">Alerts</option>
                                    <option data-icon="fa fa-certificate">Badges</option>
                                    <option data-icon="fa fa-square">Cards</option>
                                    <option data-icon="fa fa-wpforms">Forms</option>
                                    <option data-icon="fa fa-window-maximize">Modals</option>
                                </select>
                            </div>
                            <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row-wrapper">
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-6">
                                ...
                                <button type="button" class="btn btn-block btn-primary"><i class="fa fa-circle-notch fa-spin"></i></button>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <button type="button" class="btn btn-block btn-secondary"><i class="fa fa-circle-notch fa-spin"></i></button>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <button type="button" class="btn btn-block btn-tertiary"><i class="fa fa-circle-notch fa-spin"></i></button>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <button type="button" class="btn btn-block btn-danger"><i class="fa fa-circle-notch fa-spin"></i></button>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="btn-container">
                                    <button type="button" class="btn btn-primary btn-animated btn-animated-x">
                                        ...
                                        <span class="btn-inner--hidden"><i class="fa fa-play"></i></span>
                                    </button>
                                    <button type="button" class="btn btn-secondary btn-animated btn-animated-y">
                                        <span class="btn-inner--hidden">Buy</span>
                                        <span class="btn-inner--visible"><i class="fa fa-shopping-cart"></i></span>
                                    </button>
                                    <button type="button" class="btn btn-primary btn-animated btn-animated-x">
                                    ...
                                    <button type="button" class="btn btn-dark btn-animated btn-animated-y">
                                        <span class="btn-inner--visible"><i class="fa fa-play"></i></span>
                                        <span class="btn-inner--hidden"><i class="fa fa-pause"></i></span>
                                    </button>
                                </div>
                                <div class="row cols-xs-space cols-sm-space cols-md-space">
                                    <div class="col-lg-6">
                    ...
                    <div class="row-wrapper">
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">User account</button>
                                    <div class="dropdown-menu">
                                        <h6 class="dropdown-header">User menu</h6>
                                        <a class="dropdown-item" href="javascript:void(0);"><span class="float-right badge badge-primary">4</span><i class="fa fa-envelope text-primary"></i>Messages</a>
                                        <a class="dropdown-item" href="javascript:void(0);"><i class="fa fa-cog text-primary"></i>Settings</a>
                                        <div class="dropdown-divider" role="presentation"></div>
                                        <a class="dropdown-item" href="javascript:void(0);"><i class="fa fa-sign-out text-primary"></i>Sign out</a>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Notifications</button>
                                    <div class="dropdown-menu dropdown-menu-xl py-0">
                                        ...
                                        <div class="py-3 text-center"><a href="javascript:void(0);" class="link link-sm link--style-3">View all notifications</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row-wrapper">
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-6">
                                ...
                                <button type="button" class="btn btn-block btn-light" data-toggle="modal" data-target="#modal_1">Default modal</button>
                                <!-- Modal -->
                                            ...
                                            <div class="modal-body">
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-8 text-center py-4">
                                                        ...
                                                        <p class="lead text-muted">You can easy create stackable modal boxes. For example, your inline content or Ajax response can contain a gallery:</p>
                                                        <div class="py-md"><img src="./../assets/images/prv/splash.png" class="img-fluid img-center"></div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-block btn-danger" data-toggle="modal" data-target="#modal_5">Danger modal</button>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>You can easy create stackable modal boxes. For example, your inline content or Ajax response can contain a gallery:</p>
                                                </div>
                                            </div>
                    ...
                    <div class="row-wrapper">
                        ...
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Tooltip on top</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-toggle="tooltip" data-placement="right" title="Tooltip on right">Tooltip on right</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">Tooltip on bottom</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-toggle="tooltip" data-placement="left" title="Tooltip on left">Tooltip on left</button>
                            </div>
                        </div>
                        <h3 class="heading h6 text-uppercase text-primary mt-5 mb-4">Popovers</h3>
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-container="body" data-title="Please, help!" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover on top</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-container="body" data-toggle="popover" data-color="primary" data-placement="right" data-title="Please, help!" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover on right</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-container="body" data-toggle="popover" data-color="secondary" data-placement="bottom" data-title="Please, help!" data-title="Please, help!" data-content="Vivamussagittis lacus vel augue laoreet rutrum faucibus.">Popover on bottom</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-secondary" data-container="body" data-toggle="popover" data-color="tertiary" data-placement="left" data-title="Please, help!" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover on left</button>
                            </div>
                        </div>
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-danger" data-container="body" data-toggle="popover" data-color="danger" data-placement="top" data-title="Please, help!" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Danger popover</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-warning" data-container="body" data-toggle="popover" data-color="warning" data-placement="right" data-title="Please, help!" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Warning popover</button>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <button type="button" class="btn btn-block btn-success" data-container="body" data-toggle="popover" data-color="success" data-placement="left" data-title="Please, help!" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Success popover</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-wrapper">
                        <div class="col-lg-4 col-md-12">
                            ...
                            <span class="avatar avatar-lg bg-twitter mr-3"><i class="fa fa-twitter"></i></span>
                            <span class="avatar avatar-lg bg-red mr-3"><i class="fa fa-heart"></i></span>
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <span class="avatar bg-twitter mr-3"><i class="fa fa-twitter"></i></span>
                            <span class="avatar bg-red mr-3"><i class="fa fa-heart"></i></span>
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <span class="avatar avatar-sm bg-twitter mr-3"><i class="fa fa-twitter"></i></span>
                            <span class="avatar avatar-sm bg-red mr-3"><i class="fa fa-heart"></i></span>
                    ...
                    <div class="mb-5">
                        <nav class="navbar navbar-expand-lg navbar-dark bg-primary rounded">
                            <a class="navbar-brand" href="javascript:void(0);">Boomerang</a>
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar_example_1" aria-controls="navbar_example_1" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-align-justify"></i></button>
                            <div class="collapse navbar-collapse" id="navbar_example_1">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navbar_1_dropdown_1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                    ...
                    <div class="mb-5">
                        <nav class="navbar navbar-expand-lg navbar-light bg-secondary rounded">
                            <a class="navbar-brand" href="javascript:void(0);">Boomerang</a>
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar_example_2" aria-controls="navbar_example_2" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-align-justify"></i></button>
                            <div class="collapse navbar-collapse" id="navbar_example_2">
                                ...
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item"><a class="nav-link nav-link-icon" href="javascript:void(0);"><i class="fa fa-cogs"></i></a></li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link nav-link-icon" href="javascript:void(0);" id="navbar_2_dropdown_2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bell"></i></a>
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xl py-0">
                                        <div class="py-3 px-3"><h5 class="heading h6 mb-0">Notifications</h5></div>
                                            <div class="list-group">
                                                <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center">
                                                    <div class="list-group-img"><span class="avatar bg-purple">JD</span></div>
                                                    <div class="list-group-content">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link nav-link-icon" href="javascript:void(0);" id="navbar_2_dropdown_3" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user"></i></a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <h6 class="dropdown-header">User menu</h6>
                                            <a class="dropdown-item" href="javascript:void(0);"><span class="float-right badge badge-primary">4</span><i class="fa fa-envelope text-primary"></i>Messages</a>
                                            <a class="dropdown-item" href="javascript:void(0);"><i class="fa fa-cog text-primary"></i>Settings</a>
                    ...
                    <div class="">
                        <nav class="navbar navbar-expand-lg navbar-dark bg-tertiary rounded">
                            <a class="navbar-brand" href="javascript:void(0);">Boomerang</a>
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar_3" aria-controls="navbar_3" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-align-justify"></i></button>
                            <div class="collapse navbar-collapse" id="navbar_3">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item active"><a class="nav-link" href="javascript:void(0);">Home <span class="sr-only">(current)</span></a></li>
                                    <li class="nav-item"><a class="nav-link" href="javascript:void(0);">Link</a></li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navbar_3_dropdown_1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                            <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                                            <div class="dropdown-divider"></div>
                        ...
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-6">
                                <ul class="nav nav-pills nav-fill flex-column flex-sm-row" id="myTab" role="tablist">
                                    <li class="nav-item"><a class="nav-link mb-sm-3 active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">UI/UX Design</a></li>
                                    <li class="nav-item"><a class="nav-link mb-sm-3" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Programming</a></li>
                                    <li class="nav-item"><a class="nav-link mb-sm-3" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Web Development</a></li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                ...
                                <ul class="nav nav-pills nav-fill mb-3" id="tabs_2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#tabs_2_1" role="tab" aria-controls="home" aria-selected="true">
                                            <span class="nav-link-icon d-block"><i class="fa fa-connectdevelop fa-2x"></i></span>
                                            <span class="d-none d-sm-block mt-1">UI/UX Design</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tabs_2_2" role="tab" aria-controls="profile" aria-selected="false">
                                            <span class="nav-link-icon d-block"><i class="fa fa-code fa-2x"></i></span>
                                            <span class="d-none d-sm-block mt-1">Programming</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#tabs_2_3" role="tab" aria-controls="contact" aria-selected="false">
                                            <span class="nav-link-icon d-block"><i class="fa fa-laptop fa-2x"></i></span>
                                            <span class="d-none d-sm-block mt-1">Web Development</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="row-wrapper">
                        ...
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            ...
                            <div class="col-lg-6">
                                <div class=""><button type="button" class="btn btn-primary">Notifications <span class="badge badge-light ml-2">4</span></button></div>
                            </div>
                        </div>
                    ...
                    <div class="row-wrapper">
                        ...
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            ...
                            <div class="col-lg-9">
                                <p class="lead">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec ullamcorper nulla non metus auctor fringilla. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
                            </div>
                        </div>
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col-lg-3">
                    ...
                    <div class="row align-items-center mb-4 mt-lg">
                        ...
                        <div class="col-4 text-right">
                            <a href="https://fontawesome.com/v4.7.0/" target="_blank" rel="noopener noreferrer nofollow external" class="btn btn-sm btn-primary">See all icons</a>
                        </div>
                    </div>
                    ...
                    <div class="row-wrapper">
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col lg-1">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-address-book font-24"></i></div>
                                </div>
                            </div>
                            <div class="col lg-1">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-adjust font-24"></i></div>
                                </div>
                            </div>
                            <div class="col lg-1">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-archive font-24"></i></div>
                                </div>
                            </div>
                            <div class="col lg-1">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-balance-scale font-24"></i></div>
                                </div>
                            </div>
                            <div class="col lg-1">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-bed font-24"></i></div>
                                </div>
                            </div>
                            <div class="col lg-1">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-bell font-24"></i></div>
                                </div>
                            </div>
                            <div class="col lg-1">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-bicycle font-24"></i></div>
                                </div>
                            </div>
                        ...
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-angle-double-up" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-angle-double-down" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-angle-double-right" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-angle-double-left" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-angle-up" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-angle-right" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-angle-down" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-bullhorn" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-bullseye" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-calendar" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-camera-retro" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-bar-chart" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-check-circle" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-clock-o" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-cloud-download" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-cloud" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-cloud-upload" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-code" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-cogs" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-comment" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-compass" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="row cols-xs-space cols-sm-space cols-md-space">
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-credit-card" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-envelope-open" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-frown-o" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-hand-peace-o" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-handshake-o" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <div class="px-2 py-3"><i class="fa fa-heart" style="font-size: 24px;"></i></div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                <div class="px-2 py-3"><i class="fa fa-thermometer-0" style="font-size: 24px;"></i>  </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-5">
                        <a href="https://fontawesome.com/v4.7.0/"  rel="noopener noreferrer nofollow external" class="btn btn-primary">See all icons</a>
                    </div>
                </div>
            </div>
        </div>
