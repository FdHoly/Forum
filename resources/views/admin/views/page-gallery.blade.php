                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="page-gallery.html">Gallery</a></li>
                        </ul>
                    </li>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="gallery b4gallery" style="display:none;">
                                    <img data-gallery-tag="tabe1" class="gallery-item" src="../assets/images/image-gallery/1.jpg"
                                        alt="" />
                                    ...
                                    <img data-gallery-tag="tabe2" class="gallery-item" src="../assets/images/image-gallery/2.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe3" class="gallery-item" src="../assets/images/image-gallery/3.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe2" class="gallery-item" src="../assets/images/image-gallery/4.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe4" class="gallery-item" src="../assets/images/image-gallery/5.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe1" class="gallery-item" src="../assets/images/image-gallery/6.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe4" class="gallery-item" src="../assets/images/image-gallery/7.jpg"
                                        alt="" />
                                    <div class="gallery-item h-100">
                                        <div
                                    ...
                                    <img data-gallery-tag="tabe1" class="gallery-item" src="../assets/images/image-gallery/8.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe3" class="gallery-item" src="../assets/images/image-gallery/9.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe2" class="gallery-item" src="../assets/images/image-gallery/10.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe1" class="gallery-item" src="../assets/images/image-gallery/11.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe3" class="gallery-item" src="../assets/images/image-gallery/12.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe4" class="gallery-item" src="../assets/images/image-gallery/13.jpg"
                                        alt="" />
                                    <div class="gallery-item h-100">
                                        <div
                                    ...
                                    <img data-gallery-tag="tabe1" class="gallery-item" src="../assets/images/image-gallery/14.jpg"
                                        alt="" />
                                    <img data-gallery-tag="tabe4" class="gallery-item" src="../assets/images/image-gallery/15.jpg"
                                        alt="" />
                                </div>
                            </div>
                        </div>
