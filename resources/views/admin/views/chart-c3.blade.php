...
<head>
    ...
    <title>:: BigBucket :: Chart C3</title>
    ...
    <div class="main_content" id="main-content">
            ...
            <nav class="sidebar">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            <li class="active"><a href="chart-c3.html">C3 Chart</a></li>
                            <li><a href="chart-chartjs.html">Charts JS</a></li>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">C3 Chart</a>
