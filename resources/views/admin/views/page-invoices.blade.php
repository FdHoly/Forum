    ...
    <div class="main_content" id="main-content">
        ...
        <div class="left_sidebar">
            <nav class="sidebar">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active"><a href="page-invoices.html"><i class="ti-file"></i><span>Invoices</span></a></li>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Invoice</a>
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="hidden-print col-md-12 text-right">
                                        <hr>
                                        <button class="btn btn-outline-secondary"><i class="ti-printer"></i></button>
