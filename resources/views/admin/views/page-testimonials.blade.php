...
<head>
    ...
    <title>:: BigBucket :: Testimonials</title>
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="page-testimonials.html">Testimonials</a></li>
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="testimonial4">
                                            <div class="active item">
                                                ...
                                                <img class="rounded-circle float-left" src="../assets/images/xs/avatar1.jpg" alt="">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="testimonial4">
                                            <div class="active item">
                                                ...
                                                <div class="carousel-info">
                                                <img class="rounded-circle float-left" src="../assets/images/xs/avatar2.jpg" alt="">
                                                <div class="float-left">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="testimonial4">
                                            <div class="active item">
                                                ...
                                                <div class="carousel-info">
                                                <img class="rounded-circle float-left" src="../assets/images/xs/avatar3.jpg" alt="">
                                                <div class="float-left">
                                                    <h6 class="mb-0 m-t-5">Lina Mars</h6>
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="testimonial4">
                                            <div class="active item">
                                                ...
                                                <div class="carousel-info">
                                                <img class="rounded-circle float-left" src="../assets/images/xs/avatar4.jpg" alt="">
                                                <div class="float-left">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card testimonials">
                            <div class="body">
                                ...
                                <div class="m-t-30">
                                    <img class="media-object rounded-circle shadow" src="../assets/images/xs/avatar1.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card testimonials">
                            <div class="body">
                                ...
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's  took a galley of type and scrambled it to make a type specimen book.</p>
                                <div class="m-t-30">
                                    <img class="media-object rounded-circle shadow" src="../assets/images/xs/avatar2.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card testimonials">
                            <div class="body">
                                ...
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's  took a galley of type and scrambled it to make a type specimen book.</p>
                                <div class="m-t-30">
                                    <img class="media-object rounded-circle shadow" src="../assets/images/xs/avatar9.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card testimonials">
                            <div class="body">
                                ...
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's  took a galley of type and scrambled it to make a type specimen book.</p>
                                <div class="m-t-30">
                                    <img class="media-object rounded-circle shadow" src="../assets/images/xs/avatar4.jpg" alt="">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="testimonial2 default">
                                            ...
                                            <div class="testimonial-desc">
                                                <img class="media-object rounded-circle shadow" src="../assets/images/sm/avatar1.jpg" alt="">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="testimonial2 primary">
                                            ...
                                            <div class="testimonial-desc">
                                                <img class="media-object rounded-circle shadow" src="../assets/images/sm/avatar2.jpg" alt="">
                                                <div class="testimonial-writer">
                                                    <h6>Gary Camara</h6>
                                                    <span>Web Designer</span>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="testimonial3 warning">
                                            ...
                                            <div class="testimonial-desc">
                                                <img class="media-object rounded-circle shadow" src="../assets/images/sm/avatar5.jpg" alt="">
                                                <div class="testimonial-writer">
                                                    <h6>Frank Camly</h6>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="testimonial3 danger">
                                            ...
                                            <div class="testimonial-desc">
                                                <img class="media-object rounded-circle shadow" src="../assets/images/sm/avatar6.jpg" alt="">
                                                <div class="testimonial-writer">
                                                    <h6>Gary Camara</h6>
                                                    <span>ASP MVC</span>
