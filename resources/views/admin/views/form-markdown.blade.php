...
<title>:: BigBucket :: Form Markdown</title>

<link rel="stylesheet" href="../assets/vendor/themify-icons/themify-icons.css">
<link rel="stylesheet" href="../assets/vendor/fontawesome/css/font-awesome.min.css">

<link rel="stylesheet" href="../assets/vendor/markdown/bootstrap-markdown.min.css">
    ...
    <div class="main_content" id="main-content">
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Markdown</a>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <textarea id="markdown-editor" name="markdown-content" data-provide="markdown" rows="10" class="p-3"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="../assets/bundles/markdown.bundle.js"></script>
