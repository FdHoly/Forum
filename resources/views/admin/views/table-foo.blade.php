<head>
    ...
    <title>:: BigBucket :: Table Foo</title>

    <link rel="stylesheet" href="../assets/vendor/themify-icons/themify-icons.css">
    <link rel="stylesheet" href="../assets/vendor/fontawesome/css/font-awesome.min.css">

    <link rel="stylesheet" href="../assets/vendor/footable-bootstrap/css/footable.bootstrap.min.css">
    <link rel="stylesheet" href="../assets/vendor/footable-bootstrap/css/footable.standalone.min.css">
                ...
                <ul class="navbar-nav mr-auto hidden-xs">
                    <li class="nav-item page-header">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Table Foo</li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="main_content" id="main-content">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="table-foo.html">Table Foo</a></li>
                        </ul>
                    </li>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Foo Table</a>
