<head>
    ...
    <title>:: BigBucket :: Table Editable</title>
    ...
    <div class="main_content" id="main-content">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="table-editable.html">Table Editable</a></li>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Editable</a>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header pb-0">
                                <h2>Table <strong> Editable</strong></h2>
