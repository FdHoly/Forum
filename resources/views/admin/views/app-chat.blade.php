        ...
        <div class="left_sidebar">
            <nav class="sidebar">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active"><a href="app-chat.html"><i class="ti-comments"></i><span>Chat Apps</span></a></li>
                                ...
                                <div class="chat-header">
                                    <div class="user">
                                        ...
                                        <div class="chat-about">
                                            ...
                                            <div class="chat-num-messages">already 2 messages</div>
                                        </div>
                                    </div>
                                    <div class="setting">
                                        <a href="javascript:void(0);" class="btn"><i class="fa fa-gear"></i></a>
                                    </div>
                                ...
                                <ul class="chat-history">
                                    <li class="clearfix">
                                        <div class="status online message-data text-right">
                                            <span class="name">Gorge Fernandis</span>
                                    ...
                                    <li>
                                        ...
                                        <div class="message my-message">
                                            ...
                                            <div class="attachment">
                                                <a href="javascript:void(0);"><img src="../assets/images/image-gallery/2.jpg" alt="" class="img-fluid img-thumbnail"></a>
                                                <a href="javascript:void(0);"><img src="../assets/images/image-gallery/5.jpg" alt="" class="img-fluid img-thumbnail"></a>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <i class="fa fa-circle" style="color: #04BE5B; font-size: 10px;"></i>
                                        <i class="fa fa-circle" style="color: #83d0a7; font-size: 10px;"></i>
                                        <i class="fa fa-circle" style="color:#DAE9DA; font-size: 10px;"></i>
                                    </li>
                                </ul>
                                <div class="chat-box">
                                    <a href="javascript:void(0);" class="btn"><i class="fa fa-paperclip"></i></a>
                                    <a href="javascript:void(0);" class="btn"><i class="fa fa-camera"></i></a>
                                    <a href="javascript:void(0);" class="btn"><i class="fa fa-smile-o"></i></a>
                                    <a href="javascript:void(0);" class="btn"><i class="fa fa-file-text"></i></a>
                                    <a href="javascript:void(0);" class="btn"><i class="fa fa-envelope-o"></i></a>
                                    <a href="javascript:void(0);" class="btn"><i class="fa fa-drivers-license-o"></i></a>
                                    <div class="input-group">
                                        <textarea type="textarea" class="form-control" placeholder="Enter text here..." required> </textarea>
                                    </div>                                                            
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="body">
                                <div class="chat_list" id="chat_list">
                                    ...
                                    <ul class="user_list list list-unstyled mb-0 mt-3">
                                        <li>
                                            <div><img src="../assets/images/xs/avatar1.jpg" alt="avatar" /></div>
                                            <div class="about">
                                                <div class="name"><a href="javascript:void(0);">Vincent Porter</a> <small>2.38 pm</small></div>
                                                <span>Lorem Ipsum is simply printing and typesetting industry.</span>
                                                <ul class="list-unstyled team-info mb-0 mt-3">                                               
                                        ...
                                        <li>
                                            <div><img src="../assets/images/xs/avatar2.jpg" alt="avatar" /></div>
                                            <div class="about">
                                                <div class="name"><a href="javascript:void(0);">Aiden Chavez</a> <small>3.38 pm</small></div>
                                                <span>Hi Aiden, how are you?</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div><img src="../assets/images/xs/avatar3.jpg" alt="avatar" /></div>
                                            <div class="about">
                                                <div class="name"><a href="javascript:void(0);">Amy berry</a> <small>4.38 pm</small></div>
                                                <span>How is the coming along?</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div><img src="../assets/images/xs/avatar4.jpg" alt="avatar" /></div>
                                            <div class="about">
                                                <div class="name"><a href="javascript:void(0);">Albert Henry</a> <small>4.48 pm</small></div>
                                                <span>Hi Aiden, how are you?</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div><img src="../assets/images/xs/avatar5.jpg" alt="avatar" /></div>
                                            <div class="about">
                                                <div class="name"><a href="javascript:void(0);">Amy berry</a> <small>4.38 pm</small></div>
                                                <span>How is the coming along?</span>
                                            </div>
                                        ...
                                        <li>
                                            <div><img src="../assets/images/xs/avatar6.jpg" alt="avatar" /></div>
                                            <div class="about">
                                                <div class="name"><a href="javascript:void(0);">Albert Henry</a> <small>4.48 pm</small></div>
                                                <span>Hi Aiden, how are you?</span>
                                            </div>
