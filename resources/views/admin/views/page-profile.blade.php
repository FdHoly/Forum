        ...
        <div class="left_sidebar">
            <nav class="sidebar">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active"><a href="page-profile.html"><i class="ti-user"></i><span>Profile</span></a></li>
                                    ...
                                    <div class="body">
                                        <div class="new_post">
                                            ...
                                            <div class="post-toolbar-b">
                                                <button class="btn btn-warning"><i class="ti-link"></i></button>
                                                <button class="btn btn-warning"><i class="ti-camera"></i></button>
                                ...
                                <div class="card single_post">
                                    <div class="body">
                                        ...
                                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking
                                            at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal</p>
                                    </div>
                                    <div class="footer">
                                        <div class="actions">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="fancy-radio">
                                                        <label><input name="dateFormat" value="" type="radio"><span><i></i>May 18,
                                                                2018</span></label>&nbsp;&nbsp;
                                                        <label><input name="dateFormat" value="" type="radio"><span><i></i>2018, May,
                                                                18</span></label>&nbsp;&nbsp;
